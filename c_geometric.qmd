...
Una vez identificadas las geometrías que requieren validación, se extraen únicamente las edificaciones relevantes desde el archivo nacional de buildings pero dentro de un hexágono h3 específico, quedándose con edificaciones necesarias.

![Ejemplo de selección de solo puntos de edificaciones dentro del hexágono h3 de interés es decir las manzanas con mismo ID.](images/h3-pol.png)
...
![Ejemplo de distribución por conteo de edificaciones](images/distribucion-w.png)
...
![Tipos de formatos de salidas.](images/out-format.png)
